      ...
      handlers: [
        http.get("*/ideas/:ideaId", () => {
          return HttpResponse.json({
            ...
            id: "2",
            title:
              "Платформа для совместной разработки с интеграцией AI-ассистентов и автоматизированным код-ревью",
            description:
              "Разработка платформы которая объединяет возможности совместного редактирования кода, AI-ассистентов для генерации и рефакторинга, а также автоматизированного код-ревью с поддержкой множества языков программирования",
