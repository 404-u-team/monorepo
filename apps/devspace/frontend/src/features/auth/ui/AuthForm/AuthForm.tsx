    ...
    const handleSubmit = async (event: SyntheticEvent): Promise<void> => {
        ...
        try {
            ...
            if (axios.isAxiosError(error_)) {
                ...
                setError(data?.message ?? (mode === 'login' ? 'Произошла ошибка при входе' : 'Произошла ошибка при регистрации'));
            } else {
                setError(mode === 'login' ? 'Произошла ошибка при входе' : 'Произошла ошибка при регистрации');
            }
        } finally {
            setIsLoading(false);
        }
