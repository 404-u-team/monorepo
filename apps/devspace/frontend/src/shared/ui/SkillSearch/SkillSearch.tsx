...
export function SkillSearch({
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- only reload on debouncedQuery/isOpen change
    ...
    const handleSelect = useCallback((option: SkillSearchOption): void => {
        onChange(option);
        setIsOpen(false);
        setQuery('');
    }, [onChange]);

    const handleClear = useCallback((event: React.MouseEvent): void => {
