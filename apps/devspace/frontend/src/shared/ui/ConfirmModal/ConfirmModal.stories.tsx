...
export const Warning: Story = {
  args: {
    ...
    description:
      "Это действие может повлиять на другие элементы и его нельзя будет легко отменить.",
    severity: "warning",
...
export const Danger: Story = {
  args: {
    ...
    description:
      "Это действие необратимо. Все данные проекта, включая слоты и заявки, будут удалены навсегда.",
    severity: "danger",
