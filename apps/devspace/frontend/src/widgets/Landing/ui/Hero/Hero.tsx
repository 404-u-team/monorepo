      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <p className={styles.subtitle}>
            Объединяем специалистов разного уровня для создания реальных ИТ-продуктов. Нарабатывайте
            опыт в команде, расширяйте портфолио и находите единомышленников от первой идеи до
            готового релиза.
          </p>
