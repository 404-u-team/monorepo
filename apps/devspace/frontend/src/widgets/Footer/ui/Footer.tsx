            ...
            <div className={styles.container}>
                <div className={styles.top}>
                    ...
                    <div className={styles.linksBlock}>
                        ...
                        <div className={styles.column}>
                            ...
                            <ul className={styles.list}>
                                <li><Link to="/" className={styles.link}>Документация</Link></li>
                                <li><Link to="/" className={styles.link}>Блог</Link></li>
                                <li><Link to="/" className={styles.link}>Правила</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.bottom}>
                    ...
                    <div className={styles.legal}>
                        ...
                        <Link to="/" className={styles.link}>Условия использования</Link>
                    </div>
                </div>
            </div>
        </footer>
