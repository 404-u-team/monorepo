...
var ErrUserNotAuthor = errors.New("пользователь не является автором")
...
var ErrIdeaNotFound = errors.New("идея не найдена")
var ErrIdeaConflict = errors.New("идея с таким названием уже существует")
...
var ErrProjectRequestNotFound = errors.New("заявка не найдена")
